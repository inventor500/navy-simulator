Navy: time.o time.h TestShipAircraft.o Movable.o Ship.o Aircraft.o
	g++ -Wall -g -o Navy time.o Movable.o TestShipAircraft.cpp Vector3D.o Ship.o Aircraft.o
...
clean :
	rm -f time.o Navy Movable.o time.o Vector3D.o Ship.o Aircraft.o
