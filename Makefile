...
clean :
	rm -f time.o Navy Movable.o time.o Vector3D.o Ship.o Aircraft.o Cruiser.o AircraftCarrier.o Fighter.o Order.o OrderAircraft.o OrderShip.o TestShipAircraft.o Simulation.o
